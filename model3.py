...
if __name__ == "__main__":
    ...
    model = NetworkModel(picture_size=shape[1:], classes=6)
    model.fit(X_train, learning_rate=0.8,
              num_epochs=35)  # learning na poczatku moze byc duzy, nwe 0.5, i zmniejszac dynamcznie
