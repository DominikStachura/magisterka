        ...
        for num_epoch in epochs:
            for num_classes in classes:
                try:
                    ...
                    with open(f'pickle_outputs/new/parameters/class_image_dict_{str(lr).replace(".", "_")}_{num_epoch}_{num_classes}_{type(optimizer).__name__}_xavier_{str(xavier)}.pickle', 'wb') as f:
